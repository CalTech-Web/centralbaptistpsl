      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-light rounded-lg p-6">
                    ...
                    <p className="text-sm text-gray-warm mt-1">
                      Email:{" "}
                      <a
                        href="mailto:cbcpslstudentministry@gmail.com"
                        className="text-primary hover:text-secondary transition-colors"
                      >
            ...
            {/* Right Column - Service Times + Map */}
            <div>
              <h2 className="text-2xl font-bold font-[family-name:var(--font-playfair)] text-primary-dark mb-6">
                Service Times
              </h2>
              ...
              <div className="bg-light rounded-lg p-8 mb-8">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-gray-warm">
                    ...
                    <div className="flex justify-between">
                      <span>Kids Bible Study</span>
                      <span className="font-semibold">7:00 PM</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Youth Bible Study</span>
                      <span className="font-semibold">7:00 PM</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Adult Bible Study</span>
                      <span className="font-semibold">7:00 PM</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8 bg-primary text-white rounded-lg p-8 text-center">
                ...
                <p className="text-gray-300 text-sm mb-4">
                  Support the ministries of Central Baptist Church through
                  online giving via Tithely.
                </p>
                <a
