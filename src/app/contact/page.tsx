      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <h2 className="text-2xl font-bold font-[family-name:var(--font-playfair)] text-primary-dark mb-6">
                Get in Touch
              </h2>
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-primary-dark mb-1">Address</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-warm">
                      <a href="tel:7722374907" className="hover:text-secondary transition-colors">(772) 237-4907</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-warm">
                      <a href="mailto:centralbaptist2018@gmail.com" className="hover:text-secondary transition-colors">centralbaptist2018@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-light rounded-xl p-5">
                  <h3 className="font-bold text-primary-dark">Pastor Nick Manzie</h3>
                  <p className="text-sm text-gray-warm mt-1">
                    <a href="mailto:nickmanzie@centralbaptistpsl.com" className="text-primary hover:text-secondary transition-colors">nickmanzie@centralbaptistpsl.com</a>
                    {" "}&middot;{" "}
                    <a href="tel:7722492463" className="text-primary hover:text-secondary transition-colors">(772) 249-2463</a>
                  </p>
                </div>
                <div className="bg-light rounded-xl p-5">
                  ...
                  <p className="text-sm text-gray-warm mt-1">
                    <a href="mailto:donreid@centralbaptistpsl.com" className="text-primary hover:text-secondary transition-colors">donreid@centralbaptistpsl.com</a>
                    {" "}&middot;{" "}
                    <a href="tel:7728123947" className="text-primary hover:text-secondary transition-colors">(772) 812-3947</a>
                  </p>
                </div>
                <div className="bg-light rounded-xl p-5">
                  <h3 className="font-bold text-primary-dark">Prayer Concerns</h3>
                  <p className="text-sm text-gray-warm mt-1">
                    Irene Conley: <a href="tel:7728739446" className="text-primary hover:text-secondary transition-colors">(772) 873-9446</a>
                  </p>
                </div>
                <div className="bg-light rounded-xl p-5">
                  <h3 className="font-bold text-primary-dark">Children/Youth Ministries</h3>
                  <p className="text-sm text-gray-warm mt-1">
                    <a href="mailto:cbcpslstudentministry@gmail.com" className="text-primary hover:text-secondary transition-colors">cbcpslstudentministry@gmail.com</a>
                  </p>
                </div>
              </div>
            </div>
