...
const timeline = [
  ...
  },
  {
    ...
    text: <>A groundbreaking ceremony was held at the current location on <a href="https://maps.app.goo.gl/WUNtnP58udZRLRLx7" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold hover:text-primary-light transition-colors underline">202 SW Tulip Blvd in Port Saint Lucie</a>, marking the beginning of construction on the church&apos;s permanent home.</>,
