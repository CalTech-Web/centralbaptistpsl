    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="w-full h-full bg-[radial-gradient(circle_at_30%_50%,rgba(201,168,76,0.4),transparent_60%)]" />
        </div>
        <div className="relative text-center text-white px-4 max-w-4xl mx-auto">
          <p className="text-secondary tracking-[0.3em] uppercase text-sm md:text-base mb-6 font-semibold animate-fade-in-up">
            Welcome to
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <Link
                href="/contact"
                className="inline-block bg-primary text-white px-6 py-3 rounded font-bold hover:bg-primary-light transition-colors"
              >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-light rounded-xl p-8 text-center shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold font-[family-name:var(--font-playfair)] text-primary-dark mb-5">Sunday</h3>
            ...
            <div className="bg-light rounded-xl p-8 text-center shadow-sm hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold font-[family-name:var(--font-playfair)] text-primary-dark mb-5">Wednesday</h3>
              <div className="space-y-3 text-gray-warm">
                <div className="flex justify-between items-center border-b border-gray-200 pb-3">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={ministry.title} className="bg-primary/50 rounded-xl p-6 hover:bg-primary-light/50 transition-colors duration-200 border border-primary-light/20">
                <svg className="w-10 h-10 text-secondary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-center mt-10">
            <Link href="/our-ministries" className="inline-block bg-secondary text-primary-dark px-8 py-3 rounded font-bold hover:bg-secondary-light transition-colors duration-200">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <Link
                  href="/our-story"
                  className="inline-block text-secondary font-bold hover:text-secondary-light transition-colors"
                >
                  Read More &rarr;
                </Link>
              </div>
