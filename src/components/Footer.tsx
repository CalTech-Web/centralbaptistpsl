      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-primary-light text-sm italic mb-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 bg-primary rounded-full flex items-center justify-center hover:bg-primary-light transition-colors"
                aria-label="YouTube"
              >
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-300">
              <div>
                <p className="font-semibold text-primary-light">Sunday</p>
                <p>9:30 AM - Sunday School</p>
                <p>11:00 AM - Morning Worship</p>
                <p>6:00 PM - Evening Worship</p>
              </div>
              <div>
                <p className="font-semibold text-primary-light">Wednesday</p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:7722374907" className="hover:text-primary-light transition-colors">(772) 237-4907</a>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-primary-light shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:centralbaptist2018@gmail.com" className="hover:text-primary-light transition-colors">centralbaptist2018@gmail.com</a>
              </div>
            </div>
          </div>
        </div>

        <div className="mt-12 pt-8 border-t border-primary/30 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-400">
