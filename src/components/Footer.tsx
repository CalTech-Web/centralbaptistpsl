  ...
  return (
    <footer className="bg-primary-dark text-white">
      <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 bg-primary rounded-full flex items-center justify-center hover:bg-secondary transition-colors"
                aria-label="YouTube"
              >
        ...
        <div className="mt-12 pt-8 border-t border-primary-light/30 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-400">
